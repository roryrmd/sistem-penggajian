...
imported.src = '../../assets/js/moment.js';
    ...
    i.ext.buttons.print = {
        ...
        action: function(a, b, c, h) {
            ...
            g.document.body.innerHTML = "<h1>" + c.title + "</h1><div>" +
                (c.messageTop || "") + "</div>" + b + "<div>" + (c.messageBottom || "") +
                // =============================================================================================

                "<br><br><br><br><br>" +
                "<p style='text-align:right;'>Yogyakarta, " + moment().format('LL') + "</p>" +
                "<br><br><br><br>" +
                "<p style='text-align:right;'>Direktur" +
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>"
